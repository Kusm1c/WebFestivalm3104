...
{block name=body}
  <div class="container">
    ...
    {else if isset($_session_) && isset($_admin_)}
      ...
      <p><a href="list_candidature">Liste des candidatures</a> | <a href="logout">Se déconnecter</a></p>
    {else}
      <p>Bienvenue !</p>
      <p>Pour gérer votre candidature ou en poster une, veuillez <a href="login">vous connecter</a> ou <a
          href="register">vous inscrire</a></p>
    {/if}
  </div>
