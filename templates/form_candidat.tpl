          ...
          <h3>Informations sur le groupe</h2>
            ...
            <div class="row">
              ...
              <div class="group col-md-6"><br>
                ...
                <input class="form-control" type="number" id="annee" name="annee" placeholder="Année" min="1800"
                  max="2021" value={$value.annee|escape|default:''}>
  ...
  <form class="pure-form pure-form-stacked" action="form_candidat" enctype="multipart/form-data" method="post">
    <fieldset>
      ...
      <div>
        ...
        <input type="text" id="nomgrp" name="nomgrp" placeholder="Nom du groupe"
          value={$value.nomgrp|escape|default:''}>
        <span> {$messages.nomgrp|escape|default:''}</span>
      </div>
      ...
      <label for="code">Code Postal :</label>
      <input type="number" id="code" name="code" pattern="[0-9]{5}" placeholder="Code postal"
        value={$value.code|escape|default:''}>
      <span> {$messages.code|escape|default:''}</span>
      ...
      <label for="phone">téléphone:</label>
      <input type="tel" id="phone" name="phone" pattern="[0-9]{10}" placeholder="Telephone"
      ...
      <label for="annee">Année de création :</label>
      <input type="number" id="annee" name="annee" placeholder="Année" min="1800" max="2021"
      ...
      <label for="urlsite">Site web ou page facebook :</label>
      <input type="url" name="urlsite" id="urlsite" placeholder="https://groupedemusique.com" pattern="https://.*"
        size="15" value={$value.urlsite|escape|default:''}>
      <span> {$messages.urlsite|escape|default:''}</span>

      <label for="urlsoundcloud">Adresse page soundcloud (facultatif)</label>
      <input type="url" name="urlsoundcloud" id="urlsoundcloud" placeholder="https://soundcloud.com"
        pattern="https://.*" size="15" value={$value.urlsoundcloud|escape|default:''}>
      <span> {$messages.urlsoundcloud|escape|default:''}</span>


      <label for="urlyoutube">Adresse page youtube (facultatif)</label>
      <input type="url" name="urlyoutube" id="urlyoutube" placeholder="https://youtube.com" pattern="https://.*"
        size="15" value={$value.urlyoutube|escape|default:''}>
      <span> {$messages.urlyoutube|escape|default:''}</span>
      ...
      <div>
        ...
        <input type="text" id="mbr1" name="mbr1" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr1|escape|default:''}>
        <span> {$messages.mbr1|escape|default:''}</span>
      </div>
      ...
      <div>
        ...
        <input type="text" id="mbr2" name="mbr2" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr2|escape|default:''}>
        <span> {$messages.mbr2|escape|default:''}</span>
      </div>
      ...
      <div>
        <h3> Membre 3 : </h3>
        <label for="mbr2">Nom :</label>
        <input type="text" id="mbr3" name="mbr3" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr3|escape|default:''}>
        <span> {$messages.mbr3|escape|default:''}</span>
      </div>
      ...
      <div>
        <h3> Membre 4 : </h3>
        <label for="mbr2">Nom :</label>
        <input type="text" id="mbr4" name="mbr4" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr4|escape|default:''}>
        <span> {$messages.mbr4|escape|default:''}</span>
      </div>
      ...
      <div>
        <h3> Membre 5 : </h3>
        <label for="mbr2">Nom :</label>
        <input type="text" id="mbr5" name="mbr5" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr5|escape|default:''}>
        <span> {$messages.mbr5|escape|default:''}</span>
      </div>
      ...
      <div>
        <h3> Membre 6 : </h3>
        <label for="mbr2">Nom :</label>
        <input type="text" id="mbr6" name="mbr6" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr6|escape|default:''}>
        <span> {$messages.mbr6|escape|default:''}</span>
      </div>
      ...
      <div>
        <h3> Membre 7 : </h3>
        <label for="mbr2">Nom :</label>
        <input type="text" id="mbr7" name="mbr7" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr7|escape|default:''}>
        <span> {$messages.mbr7|escape|default:''}</span>
      </div>
      ...
      <div>
        <h3> Membre 8 : </h3>
        <label for="mbr2">Nom :</label>
        <input type="text" id="mbr8" name="mbr8" placeholder=" Nom Prénom (instrument)"
          value={$value.mbr8|escape|default:''}>
        <span> {$messages.mbr8|escape|default:''}</span>
      </div>
